        ...
        for (Borrower borrower : borrowers) {
            ...
            if (!borrowedItems.isEmpty()) {
                ...
                for (int i = 0; i < borrowedItems.size(); i++) {
                    ...
                    item.displayInfo(); // Display item information
                }
            } else {
...
public class LMS_Q2f {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("7. Display borrowers");
            System.out.println("8. Hot Picks"); // Added Hot Picks option
