...
public class LMS_Q2e {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        Library library = new Library();
        loadItemsFromFile(library, "data3.txt");

        System.out.println("Loaded Items from File data3.txt");
        while (true) {
            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        ...
                        saveItemsToFile(library, "data3.txt");
                        break;
                    ...
                    case 6:
                        saveItemsToFile(library, "data3.txt");
                        System.out.println("Exiting Library Management System. Items saved to data3.txt.");
                        scanner.close();
                        System.exit(0);
                        break;
